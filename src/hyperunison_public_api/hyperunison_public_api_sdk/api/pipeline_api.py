...
from ..model.multi_run_pipeline import MultiRunPipeline
from ..model.run_custom_workflow_request import RunCustomWorkflowRequest
...
class PipelineApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_multi_pipeline_endpoint = _Endpoint(
            settings={
                'response_type': (MultiRunPipeline,),
                'auth': [],
                'endpoint_path': '/api/public/pipeline/{id}',
                'operation_id': 'get_multi_pipeline',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.run_custom_workflow_endpoint = _Endpoint(
            settings={
                'response_type': (MultiRunPipeline,),
                'auth': [],
                'endpoint_path': '/api/public/pipeline/workflow/run/{pipelineVersionId}/',
                'operation_id': 'run_custom_workflow',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def run_custom_workflow(
        ...
        **kwargs
        ...
        Keyword Args:
            run_custom_workflow_request (RunCustomWorkflowRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
