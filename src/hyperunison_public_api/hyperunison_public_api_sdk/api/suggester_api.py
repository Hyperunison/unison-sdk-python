...
class SuggesterApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.generate_suggests_endpoint = _Endpoint(
            settings={
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'only_standard_concept': 'onlyStandardConcept',
                ...
                'location_map': {
                    ...
                    'domain': 'query',
                    'vocabulary': 'query',
                    'only_standard_concept': 'query',
                    'min_accuracy_to_run_gpt': 'query',
                },
